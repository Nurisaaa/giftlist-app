...
VALUES (1, current_date, 'I wish for a new laptop',
       ...
       (10, current_date, 'I wish for a beach vacation',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBU6ySk_16D_h_qq9CPL8IMNZhgQ2vMHEJkQ&usqp=CAU',
        'https://example.com/beach-vacation', 'Сертификат на салон красоты', false, false, 2, 2),
       (11, current_date, 'I wish for a new guitar',
        'https://static.gopro.com/assets/blta2b8522e5372af40/bltad363d5556c8bb87/6304d30258ce5e18d9e6d83d/hp-creator-edition-module-1920-2x.png?width=1920&quality=80&auto=webp&disable=upscale',
        'https://example.com/guitar', 'GoPro камера', false, false, 3, 3),
       (12, current_date, 'I wish for a spa weekend',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1SJWgfS-LXl1pZeq6JPxLuT1eAp3xCogGbw&usqp=CAU',
        'https://example.com/spa-weekend', 'Смартфон Xiaomi', false, false, 4, 4),
       (13, current_date, 'I wish for a cooking set',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYiv6MoL7K_T94UMWkNOrXpnocQ7vNaiE8Gg&usqp=CAU',
        'https://example.com/cooking-set', 'Абонемент в фитнес-клуб', false, false, 5, 5),
       (14, current_date, 'I wish for a tropical cruise',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWWLWmckof-TrJz9QQePkT1vtCHZ_vG4G5uA&usqp=CAU',
        'https://example.com/tropical-cruise', 'Новый книжный роман', false, false, 1, 1),
       (15, current_date, 'I wish for a sports car',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIZjWrNmuEiJaC6AfQmfj2L7XH8BJLSrJ9hg&usqp=CAU',
        'https://example.com/sports-car', 'Путешествие в Париж', false, false, 2, 2),
       (16, current_date, 'I wish for a new laptop',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSthuY19kGf6tVuytvaBPlrWCAK9z2qzDQA9w&usqp=CAU',
        'https://example.com/new-laptop', 'Фотоаппарат Canon', false, false, 3, 3),
       (17, current_date, 'I wish for a luxury watch',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbyziU5QQohGZXlyWOwTY5_byiop_WG6wUbA&usqp=CAU',
        'https://example.com/luxury-watch', 'iPhone 14', false, false, 4, 4),
       (18, current_date, 'I wish for a concert ticket',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6Vws8BKSQThCyJCAIFTDJOVeit4nsZa4rXA&usqp=CAU',
        'https://example.com/concert-ticket', 'Спортивный костюм', false, false, 5, 5),
       (19, current_date, 'I wish for a tropical vacation',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqzir1hzDnSv5I-L5c52MH6EKopkPjhSl3gg&usqp=CAU',
        'https://example.com/tropical-vacation', 'Смарт-часы', false, false, 1, 1),
       (20, current_date, 'I wish for a home theater system',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLqjvXIOQyOf0bkr-m0U0PxfhA1eQBdEbMUg&usqp=CAU',
        'https://example.com/home-theater', 'Сертификат на массаж', false, false, 2, 2),
       (21, current_date, 'I wish for a fitness membership',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBdsMKGK1NYWInqEEhKP1540sWtoaIhHXpyg&usqp=CAU',
        'https://example.com/fitness-membership', 'Компьютерная мышь', false, false, 3, 3),
       (22, current_date, 'I wish for a luxury handbag',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSB2w2JuHl_1FcGqFP7bHlYKR7sY25Dxtr-cw&usqp=CAU',
        'https://example.com/luxury-handbag', 'Планшет', false, false, 4, 4);
